...
CREATE TABLE `treasure_stages`  (
  ...
  `task_status` bigint(0) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `idx_treasure_stage_deleted_at`(`deleted_at`) USING BTREE,
  INDEX `idx_treasure_stage_user_id`(`user_id`) USING BTREE,
  INDEX `idx_treasure_stage_task_id`(`task_id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `user_power_task`  (
  ...
  `helper_user_id` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  PRIMARY KEY (`id`) USING BTREE,
